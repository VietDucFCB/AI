...
class Solution():
    ...
    def draw_legend(self):
        ...
        node1 = pydot.Node("1", style="filled", fillcolor="blue", label="Start Node", fontcolor="white", width="2",
                           fixedsize="true")
        graphlegend.add_node(node1)

        node2 = pydot.Node("2", style="filled", fillcolor="red", label="Killed Node", fontcolor="black", width="2",
                           fixedsize="true")
        ...
        node4 = pydot.Node("4", style="filled", fillcolor="gray", label="Can't be expanded", width="2",
                           fixedsize="true")
...
\ncannibals to be moved from left to right \nif s == 1 and vice versa."
        ...
        node6 = pydot.Node("6", style="filled", fillcolor="gold", label=description, shape="plaintext", fontsize=20,
                           fontcolor="red")
    ...
    def draw(self, *, number_missionaries_left, number_cannibals_left, number_missionaries_right,
